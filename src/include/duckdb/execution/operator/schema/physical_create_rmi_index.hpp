...
//                         DuckDB
//
// duckdb/execution/operator/schema/physical_create_rmi_index.hpp
//
//
//===----------------------------------------------------------------------===//
...
class PhysicalCreateRMIIndex : public PhysicalOperator {
    ...
    public:
        PhysicalCreateRMIIndex(PhysicalPlan &physical_plan, LogicalOperator &op, TableCatalogEntry &table,
